(() => {
  ...
  var LS_PASSLENGTH = "pass-enhance-passlength";
  var LS_PASSPHRASE = "pass-enhance-passphrase";

  // app/src/popup.js
  var passphraseInput = document.querySelector("#passphrase");
  var passlengthInput = document.querySelector("#passlength");
  var passlengthRangeInput = document.querySelector("#passlength-range");
  var passphrase = localStorage.getItem(LS_PASSPHRASE);
  var passLength = localStorage.getItem(LS_PASSLENGTH);
  if (!passphrase) {
    passphrase = (0, import_random_word_slugs.generateSlug)();
    passLength = 12;
